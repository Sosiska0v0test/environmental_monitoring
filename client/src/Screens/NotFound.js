...
function NotFound() {
  return (
    <div className='flex-colo gap-8 w-full min-h-screen text-white bg-black lg:py-20 py-10 px-6'>
      ...
      <Link to='/products' className='bg-subMain transitions text-white flex-rows gap-2 font-medium py-3 hover:text-main px-6 rounded-md'>
        <TbHome className='h-6 w-6 text-main' /><div className='text-main'>Назад</div>
      </Link>
    </div>
  )
}
